	...
	<div id="daisanh" class="header-page">
		...
		<div>
			<ol class="breadcrumb">
				...
				<li>
					<a class="non-textdecoration" href="user_thaoluan_khugiaitri?topicID=9">
					Khu giải trí
					</a>
				</li>
				<li class="active">
			...
			<div class="row">
				...
				<div id="contentdaisanh_post" class="col-md-10 content_daisanh_post">
					...
					<div class="post-comment row">
						...
						<form action="addCommentUser?role=4&discussionID=${discussionID}&Stitle=${Stitle}" method="post" class="col-md-11 col-xs-11">
