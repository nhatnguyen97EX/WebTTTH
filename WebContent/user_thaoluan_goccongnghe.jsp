...
<body>
	...
	<div id="daisanh" class="header-page">
		<div class="header-content">
			<h1 style="text-align: right; padding-top: 50px;">Góc công nghệ</h1>			
		</div>
		<!--
		==============================content===================================
		-->
			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li class="active"><a href="user_thaoluan_goccongnghe?topicID=6">Hỏi & đáp công nghệ</a></li>
					 	<li><a href="user_thaoluan_goccongnghe?topicID=7">Thiết bị di động</a></li>
					 	<li><a href="user_thaoluan_goccongnghe?topicID=8">Đồ điện tử</a></li>
					</ul>
				</div>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="user_thaoluan_baiviet?role=2&discussionID=${listDiscussion.discussion_id}&Stitle=Hỏi và đáp công nghệ">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
	...
	<div id="newPost" class="modalDialog">
	    ...
	    <form action="addNewPost_User?accountID=${account.account_id}&topicID=6" method="post">
	        <a href="#close" title="Close" class="close" style="color: white;"><i class="fa fa-times" style="font-size:24px"></i></a>
	        <div class="row">
