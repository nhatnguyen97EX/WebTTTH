			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li><a href="thaoluan_goccongnghe?topicID=6">Hỏi & đáp công nghệ</a></li>
					 	<li class="active"><a href="thaoluan_goccongnghe?topicID=7">Thiết bị di động</a></li>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="thaoluan_daisanh_baiviet?role=2&discussionID=${listDiscussion.discussion_id}&Stitle=Thiết bị di động">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
