			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li class="active"><a href="thaoluan_goclaptrinh?topicID=4">Hỏi đáp & bàn luận</a></li>
					 	<li><a href="thaoluan_goclaptrinh?topicID=5">Chia sẻ tài liệu</a></li>
					</ul>
				</div>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="thaoluan_daisanh_baiviet?role=3&discussionID=${listDiscussion.discussion_id}&Stitle=Hỏi đáp và bàn luận">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
