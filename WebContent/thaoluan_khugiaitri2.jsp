			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li><a href="thaoluan_khugiaitri?topicID=9">Chuyện trò linh tinh</a></li>
					 	<li class="active"><a href="thaoluan_khugiaitri?topicID=10">Game</a></li>
					</ul>
				</div>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="thaoluan_daisanh_baiviet?role=4&discussionID=${listDiscussion.discussion_id}&Stitle=Game">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
