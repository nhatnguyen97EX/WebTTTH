...
<body>
			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li><a href="user_thaoluan_goclaptrinh?topicID=4">Hỏi đáp & bàn luận</a></li>
					 	<li class="active"><a href="user_thaoluan_goclaptrinh?topicID=5">Chia sẻ tài liệu</a></li>
					</ul>
				</div>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="user_thaoluan_baiviet?role=3&discussionID=${listDiscussion.discussion_id}&Stitle=Chia sẻ tài liệu">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
	...
	<div id="newPost" class="modalDialog">
	    ...
	    <form action="addNewPost_User?accountID=${account.account_id}&topicID=5" method="post">
	        <a href="#close" title="Close" class="close" style="color: white;"><i class="fa fa-times" style="font-size:24px"></i></a>
	        <div class="row">
