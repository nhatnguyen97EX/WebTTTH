			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li class="active"><a href="thaoluan_goccongnghe?topicID=6">Hỏi & đáp công nghệ</a></li>
					 	<li><a href="thaoluan_goccongnghe?topicID=7">Thiết bị di động</a></li>
					 	<li><a href="thaoluan_goccongnghe?topicID=8">Đồ điện tử</a></li>
					</ul>
				</div>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="thaoluan_daisanh_baiviet?role=2&discussionID=${listDiscussion.discussion_id}&Stitle=Hỏi và đáp công nghệ">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
