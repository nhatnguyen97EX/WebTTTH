...
<div class="wrapper">
    ...
    <div class="main-panel">
                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                  ...
                                  <h4 class="title">${adminInfo.name}<br />
                                     <a href="#"><small>@${adminInfo.accountname}</small></a>
                                  </h4>
                                </div>
                            </div>
                            <hr>
        ...
        <!-- Modal đổi mk -->
        <div class="modal fade" id="changePass" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="padding-top: 100px;">
            <form id="avatarAdmin" action="updatePasswordAdmin" method="post">
                <div class="modal-dialog">
                    <!-- Modal content-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                    	...
                                    	<p><span style="color: red;" id="oldpass_error"></span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <p><span style="color: red;" id="password1_error"></span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <p><span style="color: red;" id="password2_error"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" id="btnChangePass" class="btn btn-default">Cập nhật</button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                        </div>
                    </div>
                </div>
