			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	...
					 	<li class="active"><a href="thaoluan_daisanh?topicID=3">Sự kiện</a></li>
					</ul>
				</div>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="thaoluan_daisanh_baiviet?role=1&discussionID=${listDiscussion.discussion_id}&Stitle=Sự kiện">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
