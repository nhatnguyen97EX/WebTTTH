...
<head>
	...
	<title>Diễn đàn - thương mại mua bán</title>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" >
						<ul class="nav navbar-nav navbar-right">  
							<li class="dropdown"><a href="trangchu.html">TRANG CHỦ</a></li>     
							<li class="dropdown">
	...
	<div id="daisanh" class="header-page">
		...
		<div>
			<ol class="breadcrumb">
				...
				<li>
					<a class="non-textdecoration" href="user_thaoluan_thuongmaivamuaban?topicID=11">
					Thương mại và mua bán
					</a>
				</li>
				<li class="active">
					${Stitle }
			...
			<div class="row">
				...
				<div id="contentdaisanh_post" class="col-md-10 content_daisanh_post">
					...
					<div class="post-comment row">
						...
						<form action="addCommentUser?role=5&discussionID=${discussionID}&Stitle=${Stitle}" method="post" class="col-md-11 col-xs-11">
						...
						<tr>
							...
							<td>
								<div class="avatar_cmt">
									<a href="#openModal${listComment.account_id}" class="post-avatar">
