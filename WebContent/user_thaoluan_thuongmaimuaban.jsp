...
<body>
	...
	<div id="daisanh" class="header-page">
		<div class="header-content">
			<h1 style="text-align: right; padding-top: 50px;">Thương mại & mua bán</h1>			
		</div>
		<!--
		==============================content===================================
		-->
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="user_thaoluan_baiviet?role=5&discussionID=${listDiscussion.discussion_id}&Stitle=Bài viết">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
	...
	<div id="newPost" class="modalDialog">
	    ...
	    <form action="addNewPost_User?accountID=${account.account_id}&topicID=11" method="post">
	        <a href="#close" title="Close" class="close" style="color: white;"><i class="fa fa-times" style="font-size:24px"></i></a>
	        <div class="row">
