	...
	<div id="daisanh" class="header-page">
		...
		<div>
			<ol class="breadcrumb">
				...
				<li>
					<a class="non-textdecoration" href="user_thaoluan_goclaptrinh?topicID=4">
					Góc lập trình
					</a>
				</li>
				<li class="active">
			...
			<div class="row">
				...
				<div id="contentdaisanh_post" class="col-md-10 content_daisanh_post">
					...
					<div class="post-comment row">
						...
						<form action="addCommentUser?role=3&discussionID=${discussionID}&Stitle=${Stitle}" method="post" class="col-md-11 col-xs-11">
