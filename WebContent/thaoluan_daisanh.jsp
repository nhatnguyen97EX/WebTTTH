	...
	<div id="daisanh" class="header-page">
		...
		<div>
			<ol class="breadcrumb">
				...
				<li>
					<a class="non-textdecoration" href="thaoluan">
					Thảo luận
					</a>
				</li>
				<li class="active">
			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li class="active"><a href="thaoluan_daisanh?topicID=1">Thông báo</a></li>
					 	<li><a href="thaoluan_daisanh?topicID=2">Thắc mắc và góp ý</a></li>
					 	<li><a href="thaoluan_daisanh?topicID=3">Sự kiện</a></li>
					</ul>
				</div>
				<div id="contentdaisanh" class="col-md-9 content_daisanh">
					<div class="content_daisanh1" style="margin-top: -2px;">
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="thaoluan_daisanh_baiviet?role=1&discussionID=${listDiscussion.discussion_id}&Stitle=Thông báo">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
