			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li><a href="thaoluan_daisanh?topicID=1">Thông báo</a></li>
					 	<li class="active"><a href="thaoluan_daisanh?topicID=2">Thắc mắc và góp ý</a></li>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="thaoluan_daisanh_baiviet?role=1&discussionID=${listDiscussion.discussion_id}&Stitle=Thắc mắc và góp ý">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
