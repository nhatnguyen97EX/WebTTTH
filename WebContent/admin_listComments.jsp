            ...
            <div class="container-fluid">
            	<div class="row">
               		<div class="btn-group" style=" padding-bottom: 15px;padding-left: 20px;">
                           <a href="forumAdmin_topic?thread=${threadID}&name=${name}" type="button" class="btn btn-default">
               	...
               	<div class="row">
               		<div class="col-md-12">
               			<div class="card">
               				<div class="header" style="float: left;">
                                <span style="font-weight: 590; font-size: 16px;">
                                	
                                    <span class="avatar">
                                        <img class="avatar" src="${disInfo.avatar}">
                                    </span>
                                   <span>${disInfo.postedby}</span>
                                
                                </span>
                                 <div class="category" title="${disInfo.postdate}" style="padding-left: 60px;">${disInfo.postdate}</div>
                            </div>
               		...
               		<div class="col-md-12">
               			<div class="card card-plain">
               				<div class="header" style="float: left;">
                                <h4 class="category">${disInfo.reply} comments</h4>
                            </div>
                            ...
                            <div class="clearfix"></div>
                            <form action="deleteComments?thread=${threadID}&name=${name}&discussionID=${discussionID}" id="form1" method="post" onsubmit="return checkCheckBoxes(this)">
	                                    	...
	                                    	<c:forEach items="${listCmt}" var="listCmt">
	                                    		<tr>
	                                    			<td style="width: 70px;">
	                                    				...
	                                    				<input type="checkbox" name="cmtDel[]" value="${listCmt.comment_id}"/>
	                                    				</div>
	                                    			</td>
	                                    			<td>
	                                    				<span class="avatar">
															<img class="avatar" src="${listCmt.avatar}">						</a>
														</span class="avatar">
														${listCmt.name}
														<div style="float: right;">
														<a class="category" href="#">
															<span title="${listCmt.time}">${listCmt.time}</span>
														</a>
														</div>
														<div class="cmt-content" style="padding-top: 10px;">
															<p>
																${listCmt.comment}
															</p>
														</div>
                        	...
                        	<form action="addCommentAdmin?discussionID=${disInfo.discussion_id}&accountID=${adminID}&thread=${threadID}&name=${name}" method="post" style="padding-top: 30px;">
	                            <div class="row">
	                                <div class="col-md-12">
	                                     <textarea rows="7" class="form-control border-input" name="message" placeholder="Leave your comment" required></textarea>
	                                </div>
                            	</div>
...
(function () {
	...
	function checkCheckBoxes(theForm) {
		var test = document.getElementsByName("cmtDel[]");
