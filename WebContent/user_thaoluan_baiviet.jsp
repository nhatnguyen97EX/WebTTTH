	...
	<div id="daisanh" class="header-page">
		...
		<div>
			<ol class="breadcrumb">
				...
				<li>
					<a class="non-textdecoration" href="user_thaoluan_daisanh?topicID=1">
					Đại sảnh
					</a>
				</li>
				<li class="active">
			...
			<div class="row">
				...
				<div id="contentdaisanh_post" class="col-md-10 content_daisanh_post">
					...
					<div class="post-comment row">
						...
						<form action="addCommentUser?role=1&discussionID=${discussionID}&Stitle=${Stitle}" method="post" class="col-md-11 col-xs-11">
						...
						<tr>
							<div class="cmt">
								...
								<div class="post-name">
									<div class="postInfo">
										<dt>
											<a href="#openModal${listComment.account_id}"> ${listComment.name}</a>
										</dt>
										<dd style="color: rgb(150,150,150);">
											<a class="dateTime" href="#">
