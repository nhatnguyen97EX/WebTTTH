...
<body>
	...
	<div class="header-page">
		<div class="header-content">
			<h1 style="text-align: right; padding-right: 0px;">Trang học
				viên</h1>
		</div>
	</div>
				...
				<div class="tab-content vertical-content ">
					...
					<div role="tabpanel"
						...
						<form class="form-horizontal" id="form_validation" method="POST"
							...
							action="UploadAvatar?IDupload=<%=acc.getAccount_id()%>"
										...
										<div class="col-md-9 col-xs-8 col-xs-8">
											<div class="form-group focused">
												<input type="text" class="form-control" name="name"
													value="<%=acc.getName()%>" required="" aria-required="true"
													aria-invalid="true"> <label id="name-error"
													class="error" for="name">Vui lòng điền họ và tên
													của bạn vào</label>
											</div>
										</div>
									</div>
									...
									<div class="row m-t-10">
										...
										<div class="col-md-9 col-xs-8 col-xs-8">
											<div class="form-group">
												...
												%>
												<input type="radio" name="gender" id="male_1" value="Nam"
													class="with-gap"> <label for="male_1">Nam</label> <input
													type="radio" name="gender" id="female_1" value="Nữ"
										...
										<div class="col-md-9 col-xs-8 col-xs-8">
											<div class="form-group">
												<input type="email" class="form-control" name="mail"
													value="<%=acc.getMail()%>" required="" aria-required="true">
												<label id="email-error" class="error" for="email">Vui
													lòng điền Email của bạn vào</label>
											</div>
										</div>
									</div>
									<div class="row m-t-10">
									...
									<div class="col-md-9 col-xs-8 col-xs-8">
										<div class="form-group">
											<input type="password" class="form-control" id="password0"
												name="password0" placeholder="Enter assword">
											<p>
									...
									where class_id=${row.class_id} and account_id=<%=acc.getAccount_id()%> ;
											...
											<c:forEach var="row2" items="${result.rows}">
												...
												<td><a class="button button-small list"
													href="DeleteStudentClass?sc_id=${row2.sc_id}" title="Edit">
				...
				<div class="footer-bottom">
					<div class="container">
						<div class="footer-center">
							© Copyright 2017. All Rights Reserved</br>Powered and Designed by
							Khang &amp; Mỹ &amp; Duyên
						</div>
					</div>
				</div>
