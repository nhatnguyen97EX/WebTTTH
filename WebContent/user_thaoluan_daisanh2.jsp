...
<body>
	...
	<div id="daisanh" class="header-page">
		<div class="header-content">
			<h1 style="text-align: right; padding-top: 50px;">Đại sảnh</h1>			
		</div>
		<!--
		==============================content===================================
		-->
			...
			<div class="row">
				<div id="menudaisanh" class="col-md-2 menu_daisanh">
					<ul class="daisanhmenu1">
					 	<li><a href="user_thaoluan_daisanh?topicID=1">Thông báo</a></li>
					 	<li class="active"><a href="user_thaoluan_daisanh?topicID=2">Thắc mắc và góp ý</a></li>
					 	<li><a href="user_thaoluan_daisanh?topicID=3">Sự kiện</a></li>
					</ul>
				</div>
						...
						<tr>
							<div class="content">
								...
								<div class="listBlock main">
									<dl>
										<h4 class="title">
											<a href="user_thaoluan_baiviet?role=1&discussionID=${listDiscussion.discussion_id}&Stitle=Thắc mắc và góp ý">${listDiscussion.title}</a>
										</h4>
									</dl>
								</div>
								</td>
	...
	<div id="newPost" class="modalDialog">
	    ...
	    <form action="addNewPost_User?accountID=${account.account_id}&topicID=2" method="post">
	        <a href="#close" title="Close" class="close" style="color: white;"><i class="fa fa-times" style="font-size:24px"></i></a>
	        <div class="row">
